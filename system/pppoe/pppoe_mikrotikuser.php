                                  ...
                                  <thead>
                                    ...
                                    <tbody>
												...
												//		<a href='index.php?page=editmikrotikuser&id=".$ARRAY[$i]['name']."'><img src='img/edit.png'         width=20px title='edit mikrotik user'></a></td>";
                                                       ...
                                                       <li><a href='index.php?page=edit_pppoe_mik_user&id=".$ARRAY[$i]['name']."'>แก้ไข</a></li>
                                                       <li><a href=\"index.php?page=pppoe_mik_user_del&id=".$ARRAY[$i]['name']."\" onclick=\"return confirm('ต้องการจะลบ  ".$ARRAY[$i]['name']."  จริงหรือไม่ ?');\">ลบ</a></td>";
