                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>   
                                            ...
                                            <th><span class="style2">Local Address</span></th>
                                            <th><span class="style2">Remote Address</span></th>
                                    ...
                                    <tbody>
												...
												<?php
													...
													echo "<tr>";
														...
														echo "<td><a class='btn btn-info btn-xs' href='index.php?page=pppoe_edit_profile&name=".$ARRAY[$i]['name']."'><span class=\"glyphicon glyphicon-edit\"></span> แก้ไข  </a></td>";
