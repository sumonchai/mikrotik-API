												...
												/*
													...
													*/
													...
													while($result=mysql_fetch_array($query)){
                                                       ...
                                                       <li><a href='index.php?page=pppoe_edituser&id=".$result['user']."'>แก้ไข</a></li>
                                                       <li><a href=\"index.php?page=pppoe_user_del&id=".$result['user']."\" onclick=\"return confirm('ต้องการจะลบ  ".$result['user']."  จริงหรือไม่ ?');\">ลบ</a></td>";														
														echo "</tr>";
