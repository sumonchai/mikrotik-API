                ...
                <div class="col-lg-12">
                    <div class="panel panel-black">
                        <div class="panel-heading"><i class="fa fa-user"></i>
                            PPPOE Databases User List   (PPPOE User ในฐานข้อมูล )
                        </div>
                        <!-- /.panel-heading -->
                                    ...
                                    <tbody>
												...
												<?php
													...
													echo "<tr>";
                                                       ...
                                                       <li><a href='index.php?page=pppoe_user&id=".$result['csv_code']."'>ดูรายชื่อ</a></li>
                                                       <li><a href='../csv/print_pppoecard.php?id=".$result['csv_code']."' target=\"_blank \">พิมพ์บัตร</a></td>";
