...
//	$list=$_REQUEST['address'];
	if($name != ""){
		mysql_query("UPDATE pppoe_pro SET pro_name='".$_REQUEST['name']."', pro_session='".$_REQUEST['session']."', pro_local='".$_REQUEST['local']."', pro_limit='".$_REQUEST['limit']."', pro_remote='".$_REQUEST['remote']."' WHERE pro_name='".$profile."'");
